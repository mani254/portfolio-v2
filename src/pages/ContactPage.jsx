...
function ContactPage() {
	...
	return (
		<div>
			<Helmet>
				<title>Contact Manikanta | Let's Build Something Great</title>
				<meta name="description" content="Get in touch with Manikanta for web development and freelancing inquiries. Let's collaborate and bring your ideas to life with expert web solutions." />
				<meta name="keywords" content="contact Manikanta, web development consultation, hire a freelancer, business inquiries, web solutions, MERN stack developer" />
				<meta name="author" content="Manikanta" />

				<meta property="og:title" content="Contact Manikanta | Let's Build Something Great" />
				<meta property="og:description" content="Have a project in mind? Contact Manikanta for expert web development and freelancing services." />
				<meta property="og:type" content="website" />
				<meta property="og:url" content="https://manidev.in/contact" />
				<meta property="og:image" content="https://manidev.in/images/home-hero-image.webp" />

				<meta name="twitter:card" content="summary_large_image" />
				<meta name="twitter:title" content="Contact Manikanta | Let's Build Something Great" />
				<meta name="twitter:description" content="Get in touch for expert web development, freelancing, and custom web solutions." />
